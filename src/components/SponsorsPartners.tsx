...
const PUCLogo = "/images/Sponsors/LogoPUC.png";
...
const SponsorsPartners = () => {
  ...
  const sponsors = {
    platinum: [
      ...
      {
        nameKey: "sponsors.PUC.name",
        logo: PUCLogo,
        url: "https://www.uc.cl/",
        descKey: "sponsors.PUC.desc",
      },
    ],
    gold: [
      {
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-1 gap-8 max-w-3xl mx-auto">
                {sponsors.platinum.map((sponsor, idx) => (
                  <Card
                    key={idx}
                    className="shadow-congress hover:shadow-warm transition-shadow border-4 border-dashed border-orange-700"
                  >
                      ...
                      >
                        <img
                          ...
                          className={`mx-auto mb-6 object-contain ${
                            sponsor.logo === PUCLogo ? "h-44 w-auto" : "h-32"
                          }`}
                        />
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center  text-primary">
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="bg-blue-800 text-primary border-orange-700 hover:bg-blue-800 hover:text-primary hover:border-orange-700"
                  >
