                ...
                <CardContent className="pt-6">
                  ...
                  <div className="space-y-3">
                    <div className="border-l-4 border-pacific-blue pl-4">
                      <h4 className="font-semibold text-foreground">{t("video.congressVision")}</h4>
                      <p className="text-muted-foreground text-sm">
                        {t("video.congressVision.desc")}
                      </p>
                    </div>
                    <div className="border-l-4 border-pacific-teal pl-4">
                      <h4 className="font-semibold text-foreground">{t("video.researchPriorities")}</h4>
                      <p className="text-muted-foreground text-sm">
                        {t("video.researchPriorities.desc")}
                      </p>
                    </div>
                    <div className="border-l-4 border-coral pl-4">
                      <h4 className="font-semibold text-foreground">{t("video.collaborationGoals")}</h4>
                      <p className="text-muted-foreground text-sm">
              ...
              <Card className="shadow-congress overflow-hidden">
                <div className="relative aspect-video bg-gradient-to-br from-volcanic to-pacific-blue flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <h3 className="text-xl font-bold mb-2">{t("video.congressIntro")}</h3>
                    <p className="text-white/80 text-sm">{t("video.duration")}</p>
                  </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <Card className="shadow-card text-center">
                  <CardContent className="pt-4">
                    ...
                    <h4 className="font-semibold text-foreground mb-1">{t("video.recognition")}</h4>
                    <p className="text-muted-foreground text-sm">{t("video.recognition.desc")}</p>
                  </CardContent>
                </Card>
              </div>
            </div>
