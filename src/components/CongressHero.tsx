...
import OceanImg from "/images/ocean.jpg"; // Placeholder image
      ...
      <div className="relative z-10 w-full px-4 text-left text-white flex justify-end ">
        <div className="max-w-5xl w-full md:w-3/4 lg:w-2/3 flex flex-col items-end">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-4xl font-bold mb-8 text-orange-800 text-opacity-65 leading-tight tracking-wider text-right w-full">
            <span className="text-blue-800"> ARCHEOLOGY CONGRESS: </span>
            <br />
          ...
          <p className="text-lg mt-4 text-accent leading-relaxed max-w-3xl text-orange-800 text-opacity-65 text-right w-full">
            ...
            leading researchers in Chile's wine country.
          </p>

          {/* <div className="flex flex-wrap justify-end gap-6 mb-12 text-white/90 w-full">
            <div className="flex items-center gap-2">
              <Calendar className="h-6 w-6 text-congress-yellow text-orange-800 text-opacity-65" />
              <span className="text-lg font-medium text-orange-800 text-opacity-65">
                March 2027
              </span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="h-6 w-6 text-congress-yellow text-orange-800 text-opacity-65" />
              <span className="text-lg font-medium text-orange-800 text-opacity-65">
                Colchagua Valley, Chile
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Users className="h-6 w-6 text-congress-yellow text-orange-800 text-opacity-65" />
              <span className="text-lg font-medium text-orange-800 text-opacity-65">
