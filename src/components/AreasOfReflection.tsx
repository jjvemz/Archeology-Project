...
const AreasOfReflection = () => {
  ...
  const areas = [
    ...
    {
      icon: TreePine,
      titleKey: "areas.diseases.title",
      scaleKey: "areas.socialScale",
      descKey: "areas.diseases.desc",
                ...
                <Card key={index} className="shadow-card hover:shadow-congress transition-all duration-300 group">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Badge variant="secondary" className="bg-pacific-blue/10 text-pacific-blue  text-primary text-opacity-65">
                        {t(area.scaleKey)}
                      </Badge>
                    </div>
          ...
          <div className="mt-16 text-center">
            <Card className="  text-primary textopacity-65 shadow-congress max-w-3xl mx-auto">
              <CardContent className="pt-8">
                <h3 className="text-2xl font-bold mb-4  text-primary ">{t("areas.multiScale.title")}</h3>
